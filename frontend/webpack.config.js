...
const PRODUCTION_API_BASE_URL = 'https://ultimateuniverse-api.azurewebsites.net/'; // to be changed to point to the URL of your API
...
const PRODUCTION_PATH_PREFIX = '/web2-2022-project-group-19/'; // e.g. '/mymovies/' if you deploy to GitHub Pages as a Project site : mymovies would be the repo name
